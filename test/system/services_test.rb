...
class ServicesTest < ApplicationSystemTestCase
  ...
  test "creating a Service" do
    ...
    fill_in "Amountofvisits", with: @service.amountofvisits
    fill_in "Description", with: @service.description
    fill_in "Durationinminutes", with: @service.durationinminutes
    fill_in "Icon", with: @service.icon
    fill_in "Name", with: @service.name
    fill_in "Price", with: @service.price
    fill_in "String", with: @service.string
    fill_in "Stype", with: @service.stype
